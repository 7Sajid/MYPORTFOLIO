export default function About() {
  return (
    <section id="about" className="flex flex-col gap-8 relative">
      <div>
        <h3 className="text-primary dark:text-primary font-semibold tracking-wide text-sm mb-2"><span className="text-rose-600 dark:text-pink-500">export default class</span> <span className="text-blue-600 dark:text-blue-400">AboutMe</span> {'{'}</h3>
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-primary">&gt;_ Who am I?</h2>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-12 items-center">
        <div className="md:w-1/2 relative group">
          ...
          <div className="relative border border-primary/30 dark:border-primary/30 bg-white/50 dark:bg-black/50 p-2">
            <img 
              src="/profile.jpg" 
              alt="Rafat Ul Aman Sajid" 
              className="w-full h-auto grayscale group-hover:grayscale-0 transition-all duration-500"
            />
            <div className="absolute bottom-4 right-4 bg-white dark:bg-background px-3 py-1 border border-primary/30 dark:border-primary/30 text-xs text-primary dark:text-primary font-bold">
              status: "online"
            </div>
          </div>
        </div>
